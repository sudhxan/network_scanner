The program discovers all the IP addresses and MAC addresses of the devices connected to a particular network. ARP packets are sent to the network asking for all the
